  ...
  return (
    ...
    >
      ...
      <div className="mx-auto flex max-w-[94%] items-center justify-between px-6 py-3.5">
        ...
        <div className="hidden lg:flex items-center gap-3.5 text-[10px] font-bold uppercase tracking-wider text-slate-600">
        ...
        <div className="flex items-center gap-4">
          <motion.a
            ...
            className="hidden md:flex items-center gap-2 text-xs font-semibold text-emerald-800 hover:text-emerald-900 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 px-4 py-2 rounded-full transition-colors whitespace-nowrap"
